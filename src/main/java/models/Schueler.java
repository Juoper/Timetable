...
public class Schueler {
    ...
    public Schueler(List<String> texte){
        ...
        //dabei steht der erste Index für die models.Stunde und der zweite für den Tag
    ...
    public void synchPlan(){
        ...
        for (int i = 0; i < 11; i++) {
            ...
            for (int j = 0; j < kNamen.get(i).size(); j++) {
                ...
                //PSeminar in der 11. models.Stunde => Do
    ...
    public boolean inKurs(String fach, String name, String lehrer){
        ...
        //System.out.println("schueler " + format(this.name, 20) + " ist " + format((b?"":" nicht "), 7) + " im models.Kurs " + name);
        return b;
    }
